import { GET } from "@/app/api/crud/user_profile/followers/[id]/route"; 
...
describe("GET followings API", () => {
  ...
  it("should return a list of user profiles for a given following ID", async () => {
    const mockRows = [
      {
        user_id: "123",
        user_name: "johndoe",
    ...
    expect(mockClient.query).toHaveBeenCalledWith(
      "SELECT up.* FROM followings AS f INNER JOIN user_profile AS up ON f.user_id = up.user_id WHERE f.following_id = $1",
      ["456"]
    );
  });
