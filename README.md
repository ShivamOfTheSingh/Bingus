...
const res = await fetch("https://production.d3drl1bcjmxovs.amplifyapp.com/api/crud/media", {
    method: "POST",
...
export async default function Page() {
    const res = await fetch("https://production.d3drl1bcjmxovs.amplifyapp.com/api/crud/media/10");
